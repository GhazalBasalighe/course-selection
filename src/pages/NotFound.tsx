const NotFound = () => {
  return (
    <div className="relative h-screen">
      <div className="absolute w-full h-full bg-[url('../../public/404bg.jpg')] bg-cover after:content-[''] after:absolute after:w-full after:h-full after:bg-[rgba(0,0,0,0.25)]"></div>
